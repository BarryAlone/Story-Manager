...
function ChapterDetail() {
  ...
  return (
    <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px' }}>
      ...
      {/* Pasek nawigacji powrotnej (Breadcrumbs) */}
        ...
        <aside style={{ width: '320px', backgroundColor: '#f9fafb', border: '1px solid #e5e7eb', borderRadius: '8px', padding: '20px', flexShrink: 0 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', fontSize: '0.9rem' }}>
            ...
            <div style={{ marginTop: '10px' }}>
              ...
              <p style={{ margin: 0, color: '#6b7280' }}>{chapter.description || 'Brak.'}</p>
            </div>
          </div>

          <button style={{ width: '100%', marginTop: '20px', padding: '10px', backgroundColor: '#374151', color: 'white', border: 'none', borderRadius: '5px', cursor: 'pointer' }}>
            Edytuj rozdział
          </button>
        </aside>
